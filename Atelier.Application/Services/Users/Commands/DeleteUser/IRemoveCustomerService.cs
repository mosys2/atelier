...
{
    public interface IRemoveCustomerService
    {
        Task<ResultDto> Execute(string UserId);

    }
    public class RemoveCustomerService : IRemoveCustomerService
    {
        private readonly IDatabaseContext _context;
        private readonly UserManager<User> _userManager;
        public RemoveCustomerService(IDatabaseContext context, UserManager<User> userManager)
        {
            _context = context;
        ...
        public async Task<ResultDto> Execute(string UserId)
        {
            ...
            if (!isCustomer)
            {
                ...
                {
                    IsSuccess = false,
                    Message = Messages.NoExistRoleCustomerInUser
                };
